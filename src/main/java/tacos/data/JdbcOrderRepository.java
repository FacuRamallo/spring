...
public class JdbcOrderRepository implements OrderRepository {
    ...
    public TacoOrder save(TacoOrder order) {
        ...
        long orderId = requireNonNull(keyHolder.getKey()).longValue();
        order.setId(orderId);
    ...
    private long saveTaco(long orderId, int i, Taco taco) {
        ...
        GeneratedKeyHolder keyHolder = new GeneratedKeyHolder(); 
        jdbcOperations.update(psc, keyHolder);
        long tacoId = requireNonNull(keyHolder.getKey()).longValue();
        taco.setId(tacoId);
    ...
    private void saveIngredientRefs(long tacoId, List<Ingredient> ingredientRefs) {
        ...
        for (Ingredient ingredientRef : ingredientRefs) {
            jdbcOperations.update(
                    "insert into Ingredient_Ref (ingredient, taco, taco_ingredient_key) "
                            + "values (?, ?, ?)",
